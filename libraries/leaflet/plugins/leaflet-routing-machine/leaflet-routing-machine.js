...
(function() {
	...
	module.exports = L.Class.extend({
		...
		initialize: function(elem, callback, context, options) {
			...
			L.DomEvent.addListener(this._elem, 'blur', this._blur, this);
...
//			geocoderInput.setAttribute('placeholder', this.options.geocoderPlaceholder(i, nWps, this));
			geocoderInput.setAttribute('placeholder', geocoder_placeholder_default(i,nWps));
			geocoderInput.addEventListener('focus', geocoder_placeholder_onfocus, false);
			geocoderInput.addEventListener('blur', geocoder_placeholder_onblur, false);
