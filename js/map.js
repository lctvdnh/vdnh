...
function page_loaded() {
	...
	tileLayer=L.tileLayer(TILES[document.getElementById('select_style').value][0], {
		maxZoom: 18,
...
function change_styles() {
	let style=document.getElementById('select_style').value;
	let url=TILES[style][0];
	tileLayer.setUrl(url,false);
}
